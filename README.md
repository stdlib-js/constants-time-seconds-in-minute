...
```javascript
SECONDS_IN_MINUTE = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-seconds-in-minute@v0.1.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-seconds-in-minute@v0.1.0-umd/browser.js"></script>
```
